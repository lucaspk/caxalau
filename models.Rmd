...
gera_previsao_terceiro_periodo <- function (notaP2) {
  ...
  modelo1.periodo2.p1.10 <- gera_modelo(alunos_selecionados, res)

  periodo <- 3
  prob.modelo.1 <- calcula_prob_reprovacao(modelo1.periodo2.p1.10, periodo)
  return (prob.modelo.1)
}
...
previsaoP1.1 <- gera_previsao_segundo_periodo(10)
previsaoP1.1
...
previsaoP2.1 <- gera_previsao_terceiro_periodo(15)
previsaoP2.1
