...
```{r}
ggplot(data = result.p3, aes(x = notas.pre, y = previsoes.p3, colour = "#FF9999")) + geom_point() + geom_line() + ggtitle("Risco de reprovacao nas cadeiras do 3º período") + xlab("Nota no pre requisito") + ylab("Risco de reprovacao")
```
