...
xx = xx %>% dcast(Matricula + Media_Int + Cod_Disciplina + Cod_Evasao + Nome_Disciplina + Situacao ~ Cod_Disciplina, value.var = "Media_Disciplina") %>% group_by(Matricula) 
...
names(xx) = c("Matricula", "Media_Int", "Cod_Disciplina", "Cod_Evasao", "Nome_Disciplina", "Situacao", "Discreta", "P1", "P2", "Grafos", "TC", "Eda", "IC", "GI", "Leda", "LP1", "LP2")
